...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const jewlery = document.getElementById('jewlery');
        const hotel = document.getElementById('hotel');
        const fishRod = document.getElementById('fishRod');

        const popupYuanbao = document.getElementById('popupYuanbao');
        const popupRice = document.getElementById('popupRice');
        const popupFish = document.getElementById('popupFish');
        ...
        if (startBtn && titleImg) {
            ...
            function popupOnce(targetImg, popupImg) {
                const rect = targetImg.getBoundingClientRect();
                const vw = window.innerWidth;
                const vh = window.innerHeight;

                const leftInVW = ((rect.left + 20) / vw) * 100;
                const topInVH = ((rect.top + 20) / vh) * 100;

                popupImg.style.left = leftInVW + 'vw';
                popupImg.style.top = topInVH + 'vh';
            ...
            jewlery.addEventListener('click', () => popupOnce(jewlery, popupYuanbao));
            hotel.addEventListener('click', () => popupOnce(hotel, popupRice));
            fishRod.addEventListener('click', () => popupOnce(fishRod, popupFish));
